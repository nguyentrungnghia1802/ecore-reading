...
interface WorkspaceHeaderProps {
  ...
  isDiagnosticsOpen?: boolean | undefined;
    ...
    <header className="workspace-header" data-testid="workspace-header">
      <div className="workspace-header__left">
        ...
        {onToggleDiagnostics && (
          <button
            type="button"
            className={`btn-icon-text ${diagnosticCount && diagnosticCount > 0 ? 'btn-icon-text--has-diagnostics' : ''} ${isDiagnosticsOpen ? 'btn-icon-text--active' : ''}`}
          ...
          >
            ...
            {diagnosticCount !== undefined && diagnosticCount > 0 && (
              <span className="workspace-header__badge" data-testid="diagnostics-badge">
                {diagnosticCount}
              </span>
            )}
          </button>
